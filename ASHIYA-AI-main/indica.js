...
app.get('/ashiya', requireAuth, (req, res) => {
  res.sendFile(path.join(__dirname, 'ashiya.html'));
});
...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    // API configuration
    const API_URL = `https://ashiya-ai.slayesh2009.workers.dev/prompt=${encodeURIComponent(message)}`;
